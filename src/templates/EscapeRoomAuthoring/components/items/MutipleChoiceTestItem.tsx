...
export const EditableMultipleChoiceTestItemContent = (
  props: EditableItemProps<MultipleChoiceTestItemDefinition>
): JSX.Element => {
  const { payload, onPayloadChanged } = props;
  const { answers, maxAnswers, minAnswers, correctAnswers, oneClickResponse } =
    payload;
  ...
  return (
    <Root>
      ...
      <ConfigureMultipleChoiceCard
        ...
        fieldPayload={{ rightAnswersEnabled: true }}
        response={{
...
export const MultipleChoiceTestItemStageSlide = (
  props: MultipleChoiceTestItemDefinition
): JSX.Element => {
...
export const multipleChoiceTestItemFactory: AbstractActivityItemFactory<MultipleChoiceTestItemDefinition> =
  {
    editingComponent: (editingProps) => (
      <EditableMultipleChoiceTestItemContent {...editingProps} />
    ),
    defaultDefinition: {
      prompt: "",
      correctAnswers: [0],
...
export default EditableMultipleChoiceTestItemContent;
