...
import { CharacterDefinition, defaultEscapeRoomActivityDefinition, EscapeRoomActivityDefinition } from '../../../src/services/escapeRoomActivity.model';
...
const EscapeRoomActivityContext = React.createContext<IEscapeRoomActivityContext>({
  //-----------------------------------------------------------------------------
  //                          ESCAPE ROOM GLOBAL DATA
  //-----------------------------------------------------------------------------
...
interface EscapeRoomContextProviderProps {
  ...
  setEscapeRoomActivityDefinition: React.Dispatch<React.SetStateAction<EscapeRoomActivityDefinition>>;
...
const EscapeRoomContextProvider = (props: EscapeRoomContextProviderProps): JSX.Element => {
  ...
  const addCharacter = (characterDef: CharacterDefinition) => {
    if (escapeRoomActivityDefinition.characters.some(character =>
  ...
  return (
    <EscapeRoomActivityContext.Provider value={{
      //-----------------------------------------------------------------------------
      //                          ESCAPE ROOM GLOBAL DATA
      //-----------------------------------------------------------------------------
      escapeRoomData: escapeRoomActivityDefinition,
