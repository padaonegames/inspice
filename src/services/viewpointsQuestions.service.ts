...
import { Question } from './viewpointsQuestion.model';
 ...
 */
export class ViewpointsQuestionsService {
  ...
  public async fetchQuestions(): Promise<ApiResult<Question[]>> {
    const questionsPath = '?action=questionlist';
    return getApiResult<Question[]>(this.apiUrl + questionsPath);
  };
}
