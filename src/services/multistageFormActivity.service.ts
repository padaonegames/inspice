...
import { MultistageFormActivityDefinition } from "./multistageFormActivity.model";
...
export class MultistageFormActivityService {
   ...
   */
  public async getMultistageFormActivityDefinitionById(
    activityId: string
  ): Promise<ApiResult<MultistageFormActivityDefinition>> {
   ...
   */
  public async deleteMultistageFormActivityDefinitionById(
    activityId: string
  ): Promise<ApiResult<MultistageFormActivityDefinition[]>> {
    const url = `${this.apiUrl}/multistage-form/activity/${activityId}`;
   ...
   */
  public async getMultistageFormActivityDefinitions(): Promise<
    ApiResult<MultistageFormActivityDefinition[]>
  > {
   ...
   */
  public async getMultistageFormActivityDefinitionsByCurrentUser(): Promise<
    ApiResult<MultistageFormActivityDefinition[]>
  > {
    const url = `${this.apiUrl}/multistage-form/user-activities`;
    return getApiResult<MultistageFormActivityDefinition[]>(url);
  } // getMultistageFormActivityDefinitionsByCurrentUser

  /**
   * @description Request a new Activity Definition on the persistence layer
   */
  public async requestNewMultistageFormActivityDefinition(): Promise<
    ApiResult<MultistageFormActivityDefinition>
  > {
    const url = `${this.apiUrl}/multistage-form/new-activity`;
    return postApiResult<{}, MultistageFormActivityDefinition>(url, {});
  } // requestNewMultistageFormActivityDefinition

  /**
   * @description Update an Activity Definition on the persistence layer
   * @param activityDefinition Activity definition to update
   */
  public async updateMultistageFormActivityDefinition(
    activityDefinition: MultistageFormActivityDefinition
  ): Promise<ApiResult<MultistageFormActivityDefinition>> {
    const url = `${this.apiUrl}/multistage-form/activity`;

    const apiDefinition: MultistageFormActivityDefinition = {
      ...activityDefinition,
    };
    ...
    return putApiResult<
      ...
      MultistageFormActivityDefinition
    >(url, apiDefinition);
  } // updateMultistageFormActivityDefinition
