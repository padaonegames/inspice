...
interface SubmitActivityPanelProps {
  onButtonClicked: () => void;
  enabled: boolean;
};

const SubmitActivityPanel: React.FC<SubmitActivityPanelProps> = ({ onButtonClicked, enabled }) => {
...
export default SubmitActivityPanel;