...
const Template: ComponentStory<typeof LikertScaleInputCard> = (args) => <LikertScaleInputCard {...args} />;

export const NoneChecked = Template.bind({});
NoneChecked.args = {
  promptText: 'Rate your experience about using our products:',
  questions: ['Merchandise', 'Books', 'Board Games', 'Consoles', 'Video Games'],
  scale: ['Very Unsatisfied', 'Unsatisfied', 'Neutral', 'Satisfied', 'Very Satisfied'],
  selectedAnswers: [undefined, 0, 1, 2, 3],
  required: false,
  requiredAlert: false
};