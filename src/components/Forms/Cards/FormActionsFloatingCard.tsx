 ...
 */
export const FormActionsFloatingCard = (
  props: FormActionsFloatingCardProps
): JSX.Element => {
  const { onAddNewTitleDescription, onAddNewQuestion } = props;
  ...
  return (
    <Root>
      ...
      />
      <AddItemIcon onClick={onAddNewQuestion} title="Add new question here" />
    </Root>
  );
};
